...
*** Test Cases ***
TC_Template_delete_002 - Delete
    [Tags]    status:ready    automation_id:tc_template_delete_002    test_type:regression    priority:high    platform:int    feature:template    function:template_delete
    [Documentation]    ลบรายการที่สร้างรูปแบบ Style 1 - 5 จำนวน 5 ข้อความ ที่มีสถานะยังไม่ถึงเวลา
