...
*** Test Cases ***
TC_Template_create_006 - Create
    [Tags]    status:ready    automation_id:tc_template_create_006    test_type:regression    priority:high    platform:int    feature:template    function:template_create
    [Documentation]    สร้าง Template รูปแบบ Custom จำนวน 1 ข้อความ ให้มีสถานะยังไม่ถึงเวลา
    ...
    ${create_name_validate}=    template_feature.Input Detail Tempale At Schedule Date And Time    ${tc_template_create_006['name_input']}    ${tc_template_create_006['message_input']}
