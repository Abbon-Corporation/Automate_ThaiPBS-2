...
*** Test Cases ***
TC_Template_create_016 - Create
    [Tags]    status:ready    automation_id:tc_template_create_016    test_type:regression    priority:high    platform:int    feature:template    function:template_create
    [Documentation]    สร้าง Template รูปแบบ Style 4 จำนวน 4 ข้อความ ให้มีสถานะกำลังใช้งานและกดปิดการใช้งานที่หน้า List
    ...
    ${create_name_validate}=    template_feature.Input Detail Tempale At Current Date And Time    ${tc_template_create_016['name_input']}    ${tc_template_create_016['message_input']}
    template_feature.Create Template Style4    ${tc_template_create_016['message_name_input']}    ${tc_template_create_016['left_image_path_01']}    ${tc_template_create_016['right_image_path_01']}    ${tc_template_create_016['message_templat_input']}    ${tc_template_create_016['color_01']}
    template_feature.Create Template Style4    ${tc_template_create_016['message_name_input']}    ${tc_template_create_016['left_image_path_02']}    ${tc_template_create_016['right_image_path_02']}    ${tc_template_create_016['message_templat_input']}    ${tc_template_create_016['color_02']}
